...
def test_short_trailing_stop_moves_down():
    ...
    # Start with a short position: entry 100, `extreme_price` stores lowest observed price
    pos = PositionData(
        symbol="SHORT",
        side="short",
        qty=1.0,
