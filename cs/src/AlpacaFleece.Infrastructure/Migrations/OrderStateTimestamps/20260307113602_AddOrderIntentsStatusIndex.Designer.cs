...
namespace AlpacaFleece.Infrastructure.Migrations.OrderStateTimestamps
{
    ...
    [Migration("20260307113602_AddOrderIntentsStatusIndex")]
    partial class AddOrderIntentsStatusIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AlpacaFleece.Infrastructure.Data.CircuitBreakerStateEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Count = 0,
                            LastResetAt = new DateTimeOffset(new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
